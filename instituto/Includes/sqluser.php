...
function showConfirmationMessagesPago($messagePago) {
    echo "<script>
        Swal.fire({
            ...
            window.location.href = '/instituto/Adman/Pantallas/alumnos-cuotas.php';
        });
    </script>";
}  
...
function insertarNuevoPago($alumnoPago, $mes, $carrera, $montoCuota) {
    ...
    if (!array_key_exists($mes, $meses)) {
        ...
        header("Location: /instituto/Adman/Pantallasalumnos-cuotas.php");
        exit();
    }
    ...
    header("Location: /instituto/Adman/Pantallas/alumnos-cuotas.php");
    exit();
}
