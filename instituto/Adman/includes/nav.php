...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item ignore-submenu" href="/instituto/Adman/Pantallas/alumnos-cuotas.php">
                <i class="app-menu__icon fas fa-dollar-sign "></i><span class="app-menu__label">Cursos-Pago</span></a>
        </li>
        <li><a class="app-menu__item ignore-submenu" href="/instituto/Adman/Pantallas/turnos.php">
