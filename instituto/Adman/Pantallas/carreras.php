        ...
        <nav class="custom-nav">
            <div class="menu-group">
                <ul class="custom-menu-list">
                    ...
                    <a class="custom-menu-link" href="/instituto/Adman/Pantallas/carreras.php">Nuestros Cursos</a>
            ...
            <div class="row">
                <div class="col-md-6" id="columna1">
                    <a href="<?php echo '/instituto/Adman/subPantallas/carrera_analista.php'; ?>"  class="card">
                        <img src="/instituto/Imagenes/curso_barberia.jpeg" alt="Analista de Sistemas" />
                        <div class="centrado">
                ...
                <div class="col-md-6" id="columna2">
                    <a href="<?php echo '/instituto/Adman/subPantallas/carrera_redes.php'; ?>"  class="card">
                        <img src="/instituto/Imagenes/curso-colimentria.jpeg" alt="Redes Informáticas" />
                        <div class="centrado">
